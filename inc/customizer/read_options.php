...
class GBT_Opt {
	...
	private static function theme_defaults() {
		return [
			...
			'footer_text' 							=> esc_html__('Powered by ', 'the-hanger' ) . '<a href="'.TH_THEME_WEBSITE.'" title="eCommerce WordPress Theme for WooCommerce">' . esc_html__( 'The Hanger', 'the-hanger' ) . '</a>.',
