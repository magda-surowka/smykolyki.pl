	...
	class GBT_InstallWizard {
		...
		public function setup_wizard_steps() {
			...
			<div class="gbt-wizard-logo <?php echo GBTHELPERS::theme_slug(); ?>">
				<a href="#">
					<img src="<?php echo esc_url( get_template_directory_uri() .'/inc/admin/wizard/images/thehanger-logo-w.png' ); ?>" <?php echo file_exists(get_template_directory() .'/inc/admin/wizard/images/thehanger-logo-w@2x.png')? 'srcset="'.esc_url( get_template_directory_uri() .'/inc/admin/wizard/images/thehanger-logo-w@2x.png 2x'.'"' ) : '' ; ?> alt="Logo">
				</a>
			</div>
		...
		public function gbt_setup_introduction() {
			?>
				<div class="wrapper wizard-introduction">
					<img src="<?php echo esc_url( get_template_directory_uri() .'/inc/admin/wizard/images/setup-wizard-start.jpg' ); ?>" alt="Page Setup Introduction">
					...
					<li class="plugin <?php echo esc_attr( $slug ); ?>">
						...
						<label for="<?php echo esc_attr($plugin['slug']); ?>" class="<?php echo ( isset($plugin['demo_required']) && $plugin['demo_required'] === true ) ? 'required' : 'optional' ?>">
							...
							<div class="plugin-description-container">
								...
								<p><?php echo isset( $plugin['description'] )? esc_html( $plugin['description'], 'the-hanger' ) : ''; ?></p>
							</div>
		...
		public function gbt_setup_demo() {
			...
			<div class="wrapper wizard-demo-import">
				...
				<div class="demo-icon <?php echo ( ! $is_required_plugins === true) ? 'error' : '' ?>">
					...
					<?php else : ?>
						<img src="<?php echo esc_url( get_template_directory_uri() .'/inc/admin/wizard/images/install-demo-import-error.png' ); ?>" alt="Demo Import">
		...
		public function gbt_setup_final() {
			...
			<div class="wrapper wizard-ready">
				<img src="<?php echo esc_url( get_template_directory_uri() .'/inc/admin/wizard/images/setup-wizard.jpg' ); ?>" alt="Page Setup Ready">
				<div class="content-info">
				...
				<div class="further-info">
					<div class="column">
						...
						<a href="<?php echo esc_url( home_url() ); ?>" class="button button-primary"><?php esc_html_e( 'View Site', 'the-hanger' );?></a>
					</div>
					<div class="column last">
						...
						<ul>
							...
							<li><a href="<?php echo esc_url( admin_url( 'admin.php?page=wc-admin&path=%2Fsetup-wizard' ) );?>"><span class="dashicons dashicons-admin-settings"></span><?php esc_html_e( 'WooCommerce Setup Wizard', 'the-hanger' ); ?></a></li>
