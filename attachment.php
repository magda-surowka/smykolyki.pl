			...
			<div class="small-12 columns">
				...
				<div class="site-content">
					...
					<header class="entry-header">
					 ...
					 <div class="nav-links">
					    <?php previous_image_link( false, '<span class="previous-image">' . esc_html__( 'Previous ', 'the-hanger' ) . '</span>' ); ?>
					    <?php next_image_link( false, '<span class="next-image">' . esc_html__( 'Next ', 'the-hanger' ) . '</span>' ); ?>
					</div><!-- .nav-links -->
