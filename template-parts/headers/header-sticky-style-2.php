			...
			<div class="header-content">
				...
				<div class="header-branding site-secondary-font">
					...
					<?php if ( ! empty( GBT_Opt::getOption('simple_header_logo') ) ) : ?>
						...
						<div class="site-logo"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php echo esc_url( GBT_Opt::getOption('simple_header_logo') ); ?>" title="<?php bloginfo('name'); ?>" alt="<?php bloginfo('name'); ?>" width="<?php echo esc_attr(GBT_Opt::getOption('simple_header_logo_width')); ?>"></a></div>
